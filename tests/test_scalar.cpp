...
TEST_CASE("scalar dual arithmetic", "[scalar][forward]") {
    ...
    SECTION("Edge cases") {
        ...
        // Test sqrt(0)
        scalar<double> sqrt_zero(sqrt(zero));
